 ...
 * for the Session and Application FIX events
 */
@Slf4j
@Component
public class FixApplicationAdapter implements Application {
    ...
    public void onLogon(SessionID sessionId) {
		...
		tradeController.setSessionID(sessionId);
		tradeController.setSessionLoggedOn(true);
    }

    @Override
    public void onLogout(SessionID sessionId) {
        log.info("onLogout: SessionId={}", sessionId);
		tradeController.setSessionLoggedOn(false);
		tradeController.setSessionID(null);
    }
